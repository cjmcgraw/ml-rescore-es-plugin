...
if __name__ == '__main__':
    ...
    p.add_argument("--model-domain", default="half-plus-three-model:8500")
    args = p.parse_args()
    ...
    for itemid_field in ['itemId1', 'itemId2', 'itemId3']:
        for v in string.ascii_lowercase:
            ...
            actualScores = [round(r['_score'], 8) for r in raw_data]
            expectedScores = [round(float(1.0 / r[itemid_field]), 8)  for r in data]
